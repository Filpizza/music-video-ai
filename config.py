...
# 6 = честный максимум для 2 сцен с автопроверкой (2 сцены × 3 попытки),
# худший случай 6 × $0.02 = $0.12 за запуск.
MAX_IMAGES_PER_RUN = int(os.getenv("MAX_IMAGES_PER_RUN", "6"))
